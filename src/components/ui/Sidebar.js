...
export default function Sidebar() {
  return (
    <div className='md:w-2/5 xl:w-1/5 bg-gray-800 min-h-screen'>
      ...
      <nav>
        <NavLink className="newLink"   exact to='/'>Órdenes</NavLink>
        <NavLink className="newLink"   exact to='/menu'>Menú</NavLink>
        <NavLink className="newLink"   exact to='/nuevo-platillo'>Nuevo Plato</NavLink>
      </nav>
      </div>
